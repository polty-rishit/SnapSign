      ...
      <div className="flex-1 flex items-center justify-center relative overflow-hidden">
        ...
        <div className="relative z-30 w-full max-w-md mx-auto p-8 bg-black/80 backdrop-blur-sm border border-gray-800 rounded-lg shadow-2xl mb-12 mt-10">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-400">Join IRON PULSE and transform your fitness journey today.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="text-center mt-6  ">
              <p className="text-gray-400">
                Already have an account? <a href="/SignIn" className="text-orange-500 hover:text-orange-400 transition-colors duration-300">Sign In</a>
              </p>
            </div>
          </form>
        </div>
